...
for( var i=0; i<=lista.length;i++){
   ...
   items = '<tr>'+
                ...
                '</tr>';
                document.getElementById("tbody").insertRow(-1).innerHTML = items;
                document.getElementById("colorear").style.backgroundColor = "grey";
                document.getElementById("colorear").style.color="white";
}
